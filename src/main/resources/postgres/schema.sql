...
create table player (
	...
	birth_country_ref_id BIGINT REFERENCES birth_country_ref (id) NOT NULL,
	gender_ref_id BIGINT REFERENCES gender_ref (id) NOT NULL,
	email VARCHAR(50) NOT NULL,
	image_ref_id BIGINT REFERENCES image_ref (id),
	phone VARCHAR(50),
...
create table player_game_history (
	...
	russian_adjective_ending_ref_id BIGINT REFERENCES russian_adjective_ending_ref (id) NOT NULL,
	russian_noun_id BIGINT REFERENCES russian_noun (id) NOT NULL,
	russian_noun_ending_ref_id BIGINT REFERENCES russian_noun_ending_ref (id) NOT NULL,
	iscorrect BOOLEAN
);
